$(document).ready(function() {
    ...
    $('.hamburger').on('click', function(event) {
        $('.translation-note-container').find('.tab-title').toggleClass('note-menu-show')
        $('.translation-note-container').find('.translation-note-overlay').toggleClass('app-note-overlay-show')
    })
    $('.translation-note-overlay').on('click', function(e){
        $(this).parents('.translation-note-container').children('.tab-title').removeClass('note-menu-show')
        $(this).removeClass('app-note-overlay-show')
    })
    $('.tab-title .nav-pills a.nav-link').on('click', function(event) {
        $(this).parents('.translation-note-container').find('.tab-title').removeClass('note-menu-show')
        $(this).parents('.translation-note-container').find('.translation-note-overlay').removeClass('app-note-overlay-show')
    })
