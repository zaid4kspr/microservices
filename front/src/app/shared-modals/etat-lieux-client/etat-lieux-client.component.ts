...
declare var $
@Component({
  selector: 'app-etat-lieux-client',
  templateUrl: './etat-lieux-client.component.html',
  styleUrls: ['./etat-lieux-client.component.scss']
})
export class EtatLieuxClientComponent implements OnChanges {
