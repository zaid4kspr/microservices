...
@Component({
  selector: 'retour-packaging-html-to-pdf',
  templateUrl: './retour-html-to-pdf.component.html',
  styleUrls: ['./retour-html-to-pdf.component.scss']
})
export class RetourHtmlToPdfComponent implements OnChanges {
...
today = new Date();
  ...
  generatePDF() {
    ...
    html2canvas(data,{
      ...
      pdf.save("Retour-" + this.deliveryRequests[0]._id.substr(0,5) + '.pdf');
      $('#retourModal').modal('toggle');
